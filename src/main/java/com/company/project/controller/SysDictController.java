...
public class SysDictController {
    ...
    @PostMapping("/getTypeByNameAndValueLike")
    @RequiresPermissions("sysDict:list")
    @ResponseBody
    public DataResult getGradeByCondition(@RequestBody String jsonData){
        System.out.println("type:" + jsonData );
        JSONObject object = JSONObject.parseObject(jsonData);
        List<SysDictDetailEntity> typeByNameAndValueLike = sysDictService.getTypeByNameAndValueLike(object.get("type").toString(), object.get("valueLike").toString());
        System.out.println(typeByNameAndValueLike);
        return DataResult.success(typeByNameAndValueLike);
    }
