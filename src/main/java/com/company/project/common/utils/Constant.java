...
public class Constant {
     ...
     * redis的一些常用数据的key
     */
    public static final String CLASS_DATA_KEY = "dl:base-data:class-data";//班级
    public static final String GRADE_DATA_KEY = "dl:base-data:grade-data";//年级
    public static final String TEACHER_DATA_KEY = "dl:base-data:teacher-data";//教师
    public static final String CLASSROOM_DATA_KEY = "dl:base-data:classroom-data";//教室


    /**
     *
     */
    public static final String SCHOOL_NAME = "立信中学";

    public static final String TEACHER_ROLE_ID = "1331087516021194754";
